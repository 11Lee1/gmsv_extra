...
namespace GarrysMod
{
	namespace Lua
	{
		...
		public:
			...
			/*69 - 276*/virtual void			SetMemberEntity(char const*, CBaseEntity*);
			/*70 - 280*/virtual void			SetMemberEntity(float, CBaseEntity*);
			/*71 - 284*/virtual bool			IsEntity();
			/*72 - 288*/virtual CBaseEntity*	GetEntity();
			/*73 - 292*/virtual void			SetEntity(CBaseEntity*);
			/*74 - 396*/virtual void			SetMemberVector(float, Vector*);
			/*75 - 300*/virtual void			SetMemberVector(char const*, Vector&);
			/*76 - 304*/virtual void			SetMemberVector(char const*, Vector*);
			/*77 - 308*/virtual Vector&			GetMemberVector(int);
			/*78 - 312*/virtual	Vector&			GetMemberVector(char const*, Vector*);
