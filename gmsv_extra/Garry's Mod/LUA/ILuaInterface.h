...
public:
	...
	/*48 - 192*/virtual void				PushAngle(QAngle const&) = 0;
	/*49 - 196*/virtual void				PushVector(Vector const&) = 0;
	/*50 - 200*/virtual void				SetState(lua_State*) = 0;
	/*51 - 204*/virtual void				CreateMetaTable(const char*) = 0;
	/*52 - 208*/virtual bool				PushMetaTable(int) = 0;
	/*53 - 212*/virtual void				PushUserType(void*, int) = 0;
	...
	/*59 - 236*/virtual GarrysMod::Lua::CLuaObject* Lua_GetObject(int) = 0; // 236 - 59
	/*60 - 240*/virtual void				PushLuaObject(GarrysMod::Lua::ILuaObject*) = 0; // 240 - 60
	/*61 - 244*/virtual void				PushLuaFunction(GarrysMod::Lua::CFunc) = 0;
	/*62 - 248*/virtual int					LuaError(const char*, int) = 0;
	/*63 - 252*/virtual int					TypeError(const char*, int) = 0;
	/*64 - 256*/virtual bool				CallInternal(int, int) = 0;
	/*65 - 260*/virtual bool				CallInternalNoReturns(int) = 0;
	/*66 - 264*/virtual bool				CallInternalGetBool(int) = 0;
	/*67 - 268*/virtual char const*			CallInternalGetString(int) = 0;
	/*68 - 272*/virtual bool				CallInternalGet(int, GarrysMod::Lua::ILuaObject*) = 0;
	/*69 - 276*/virtual void				NewGlobalTable(const char*) = 0;
	/*70 - 280*/virtual GarrysMod::Lua::CLuaObject* NewTemporaryObject() = 0; // 280 - 70
	/*71 - 284*/virtual bool				isUserData(int) = 0;
	/*72 - 288*/virtual GarrysMod::Lua::ILuaObject* GetMetaTableObject(int iType) = 0;
	/*73 - 292*/virtual GarrysMod::Lua::ILuaObject* GetMetaTableObject(const char* szName, int iType) = 0;
	/*74 - 296*/virtual GarrysMod::Lua::CLuaObject* GetReturn(int) = 0;
	/*75 - 300*/virtual bool				IsServer(void) = 0;
	/*76 - 304*/virtual bool				IsClient(void) = 0;
	/*77 - 308*/virtual bool				IsMenu(void) = 0;
	/*78 - 312*/virtual void				DestroyObject(GarrysMod::Lua::ILuaObject*) = 0;
	/*79 - 316*/virtual GarrysMod::Lua::CLuaObject* CreateObject(void) = 0;
	/*80 - 320*/virtual void				SetMember(GarrysMod::Lua::ILuaObject*, const char*, GarrysMod::Lua::ILuaObject*) = 0;
	/*81 - 324*/virtual void				SetMember(GarrysMod::Lua::ILuaObject*, const char*) = 0;
	/*82 - 328*/virtual void				SetMember(GarrysMod::Lua::ILuaObject*, float, GarrysMod::Lua::ILuaObject*) = 0;
	/*83 - 332*/virtual void				SetMember(GarrysMod::Lua::ILuaObject*, float) = 0;
	/*84 - 336*/virtual	void				SetMember(GarrysMod::Lua::ILuaObject*, GarrysMod::Lua::ILuaObject*, GarrysMod::Lua::ILuaObject*) = 0; // 320 - 80 
	/*85 - 340*/virtual GarrysMod::Lua::CLuaObject* GetNewTable(void) = 0;
	/*86 - 344*/virtual void				SetType(unsigned char) = 0;
	/*87 - 348*/virtual void				PushLong(long) = 0;
	/*88 - 352*/virtual int					GetFlags(int) = 0;
	/*89 - 356*/virtual bool				FindOnObjectsMetaTable(int, int) = 0;
	/*90 - 360*/virtual bool				FindObjectsOnMetaTable(int, int) = 0;
	/*91 - 364*/virtual void				SetMemberFast(GarrysMod::Lua::ILuaObject*, int, int) = 0;
	...
	/*94 - 376*/virtual void				Error(const char*) = 0;
