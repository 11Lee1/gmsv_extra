...
public:
	...
	enum
	{
		//SNAPSHOT_SCRATCH_BUFFER_SIZE = 32768, // 0x8000
		SNAPSHOT_SCRATCH_BUFFER_SIZE = 1048624, // 0x100030 
	};

	unsigned int			m_SnapshotScratchBuffer[SNAPSHOT_SCRATCH_BUFFER_SIZE / 4];  // 0x4000C lol ok.
