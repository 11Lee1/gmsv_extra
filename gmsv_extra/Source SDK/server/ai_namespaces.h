...
public:
	...
	bool Init(CAI_GlobalNamespace *pGlobalNamespace, CAI_LocalIdSpace *pParentIDSpace = 0);
...
public:
	...
	bool Init(const char *pszClassName, CAI_GlobalScheduleNamespace *pGlobalNamespace, CAI_ClassScheduleIdSpace *pParentIDSpace = 0);
...
inline bool CAI_ClassScheduleIdSpace::Init(const char *pszClassName, CAI_GlobalScheduleNamespace *pGlobalNamespace, CAI_ClassScheduleIdSpace *pParentIDSpace)
{
	...
	return (m_ScheduleIds.Init(&pGlobalNamespace->m_ScheduleNamespace, (pParentIDSpace) ? &pParentIDSpace->m_ScheduleIds : 0) &&
		m_TaskIds.Init(&pGlobalNamespace->m_TaskNamespace, (pParentIDSpace) ? &pParentIDSpace->m_TaskIds : 0) &&
		m_ConditionIds.Init(&pGlobalNamespace->m_ConditionNamespace, (pParentIDSpace) ? &pParentIDSpace->m_ConditionIds : 0));
}
